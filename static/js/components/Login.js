const Login={
  ...
  template:`
  <div class="row justify-content-center mt-5" style="background-image:url('/static/background.png');background-size:cover;background-position:center;min-height:100vh;width:100%;height:100%;">
  <div class="col-md-4">
